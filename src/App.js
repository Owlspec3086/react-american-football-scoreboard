...
function App() {
  ...
  // these are the [value, setValue] for the Lions and Tigers
    ...
    <div className='container'>
      ...
      <section className='buttons'>
        <div className='homeButtons'>
          ...
          {/* This is the click listener for the home score which is 7 on a touchdown */}
          <button className='homeButtons__touchdown' onClick={() => setHome(homeScore + 7)}>Home TouchDown</button>
          {/* CLick listener for the field goal which is 3 points */}
          <button className='homeButtons__fieldGoal' onClick={() => setHome(homeScore + 3)}>Home Field Goal</button>
        </div>
        <div className='awayButtons'>
          {/* This is the click listener for the away score which is also 7 on a touchdown */}
